...
export interface RequestHeader { id?: number; roomNumber: string | null; status: 'Pending' | 'Acknowledged' | 'Delivered'; employeeId: number; employee?: Employee; updatedBy?: Employee | null; roomListId: number; lines: RequestLine[]; createdAt?: string; updatedAt?: string;  notes?: string; }
